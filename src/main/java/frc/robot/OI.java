...
public class OI {
  ...
  public Button zeroElevator = new JoystickButton(rightStick, Constants.kZeroElevator);
  public Button level1Elevator = new JoystickButton(rightStick, Constants.kLevel1Elevator);
  public Button level2Elevator = new JoystickButton(rightStick, Constants.kLevel2Elevator);
  public Button level3Elevator = new JoystickButton(rightStick, Constants.kLevel3Elevator);
